...
`chdir("/tmp")                           = 0`
### Решение:
`strace /bin/bash -c 'cd /tmp' > strace.log 2>&1'`  
`grep tmp strace.log`
...
vim       1540                       vagrant    4u      REG              253,0     4096     131100 /home/vagrant/.test.txt.swp
vagrant@vagrant:~$ rm .test.txt.swp
vagrant@vagrant:~$ lsof | grep test
vim       1540                       vagrant    4u      REG              253,0     4096     131100 /home/vagrant/.test.txt.swp (deleted)
